...
public class levelArrow2 : MonoBehaviour {
	...
	void OnTriggerEnter2D(Collider2D other){
		if (other.gameObject.tag == ("Player")) {
			...
			Instantiate (levelcard, new Vector2 (209.93f, 1.64f), Quaternion.identity);
	...
	void levelThrow () 
	{
		Instantiate (levelthrow, new Vector2 (210.08f, -1.28f), Quaternion.identity);
	}
